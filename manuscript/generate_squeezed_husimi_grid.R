...
# Output filenames
file_output_pdf  <- file.path(dir_manuscript, "squeezed_husimi.pdf")
file_output_png  <- file.path(dir_manuscript, "squeezed_husimi.png")
...
cat("Success! Kinematic Wigner-Husimi plots generated in", dir_manuscript, ":\n")
