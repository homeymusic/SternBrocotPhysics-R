...
# Output filenames
file_output_pdf  <- file.path(dir_manuscript, "encoding_grid.pdf")
file_output_png  <- file.path(dir_manuscript, "encoding_grid.png")
...
# Targets defined by the user (Updated to 5 rows)
