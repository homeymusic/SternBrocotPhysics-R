...
#' @export
micro_macro_bell_erasure_sweep <- function(angles, dir, count, n_threads = 0L) {
    invisible(.Call(`_SternBrocotPhysics_micro_macro_bell_erasure_sweep`, angles, dir, count, n_threads))
}
