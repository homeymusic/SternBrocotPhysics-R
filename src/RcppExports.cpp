...
// action_angle_erase_depth
DataFrame action_angle_erase_depth(NumericVector x, int depth);
RcppExport SEXP _SternBrocotPhysics_action_angle_erase_depth(SEXP xSEXP, SEXP depthSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
    Rcpp::traits::input_parameter< int >::type depth(depthSEXP);
    rcpp_result_gen = Rcpp::wrap(action_angle_erase_depth(x, depth));
    return rcpp_result_gen;
END_RCPP
}
