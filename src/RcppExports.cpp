...
void micro_macro_bell_erasure_sweep(NumericVector angles, std::string dir, int count, double kappa, double delta_particle, double mu_start, double mu_end, int n_threads);
RcppExport SEXP _SternBrocotPhysics_micro_macro_bell_erasure_sweep(SEXP anglesSEXP, SEXP dirSEXP, SEXP countSEXP, SEXP kappaSEXP, SEXP delta_particleSEXP, SEXP mu_startSEXP, SEXP mu_endSEXP, SEXP n_threadsSEXP) {
BEGIN_RCPP
    ...
    micro_macro_bell_erasure_sweep(angles, dir, count, kappa, delta_particle, mu_start, mu_end, n_threads);
    return R_NilValue;
END_RCPP
}
// erase_uncertainty
...
static const R_CallMethodDef CallEntries[] = {
    {"_SternBrocotPhysics_micro_macro_bell_erasure_sweep", (DL_FUNC) &_SternBrocotPhysics_micro_macro_bell_erasure_sweep, 8},
