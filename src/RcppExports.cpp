...
void micro_macro_bell_erasure_sweep(NumericVector angles, double detector_aperture, std::string dir, int count, double kappa, double delta_particle, double mu_start, double mu_end, int n_threads);
RcppExport SEXP _SternBrocotPhysics_micro_macro_bell_erasure_sweep(SEXP anglesSEXP, SEXP detector_apertureSEXP, SEXP dirSEXP, SEXP countSEXP, SEXP kappaSEXP, SEXP delta_particleSEXP, SEXP mu_startSEXP, SEXP mu_endSEXP, SEXP n_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type angles(anglesSEXP);
    Rcpp::traits::input_parameter< double >::type detector_aperture(detector_apertureSEXP);
    Rcpp::traits::input_parameter< std::string >::type dir(dirSEXP);
    Rcpp::traits::input_parameter< int >::type count(countSEXP);
    Rcpp::traits::input_parameter< double >::type kappa(kappaSEXP);
    Rcpp::traits::input_parameter< double >::type delta_particle(delta_particleSEXP);
    ...
    micro_macro_bell_erasure_sweep(angles, detector_aperture, dir, count, kappa, delta_particle, mu_start, mu_end, n_threads);
    return R_NilValue;
END_RCPP
}
// erase_uncertainty
...
// micro_macro_erasures_momentum
void micro_macro_erasures_momentum(NumericVector momenta, std::string dir, int count, int n_threads);
RcppExport SEXP _SternBrocotPhysics_micro_macro_erasures_momentum(SEXP momentaSEXP, SEXP dirSEXP, SEXP countSEXP, SEXP n_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type count(countSEXP);
    Rcpp::traits::input_parameter< int >::type n_threads(n_threadsSEXP);
    micro_macro_erasures_momentum(momenta, dir, count, n_threads);
    return R_NilValue;
END_RCPP
}
// find_nodes_cpp
...
static const R_CallMethodDef CallEntries[] = {
    {"_SternBrocotPhysics_micro_macro_bell_erasure_sweep", (DL_FUNC) &_SternBrocotPhysics_micro_macro_bell_erasure_sweep, 9},
    ...
    {"_SternBrocotPhysics_micro_macro_erasures_momentum", (DL_FUNC) &_SternBrocotPhysics_micro_macro_erasures_momentum, 4},
