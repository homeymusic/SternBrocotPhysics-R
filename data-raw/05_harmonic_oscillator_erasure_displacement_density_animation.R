...
cat(sprintf("FINAL RENDER: Processing %d frames with 25pt margins...\n", nrow(dt_files_to_process)))
...
p <- ggplot() +
  ...
  theme(
    ...
    # 25pt protective gutter for all OS window chrome
