...
# Set file dimensions slightly taller than width to accommodate legend/title 
# while keeping the inner plot area square.
dynamic_width  <- 8 
dynamic_height <- 8.5 
...
p_main <- ggplot(plot_dt, aes(x = delta_q)) +
  ...
  theme(
    ...
    # FORCES the plotting panel to be a perfect square
    aspect.ratio = 1 
  ) +
  coord_cartesian(xlim = q_range, ylim = y_range, expand = TRUE)
