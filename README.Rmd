...
```{r plot-eigen-grid-display-dynamic, echo=FALSE, fig.width=10, fig.height=eigen_height, warning=FALSE, message=FALSE}
# This displays the grid showing the "Inaccessible" placeholders for n=3, 8, 20, etc.
