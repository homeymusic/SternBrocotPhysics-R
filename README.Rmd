...
find_nodes_outward <- function(df, scan_direction = "right") {
  ...
  # DC Noise Removal: Isolate the dynamic signal from the baseline
  ...
  # REFINED SIGNIFICANCE: Ensure the signal 'exists' above the baseline
  # High-energy QHO check: Is the range significant compared to local mean?
  ...
  for (i in seq_len(nrow(df) - 1)) {
    # DC-INDEPENDENT CHANGE: 
    # Normalizing by h_range effectively 'strips' the DC offset (h_min)
