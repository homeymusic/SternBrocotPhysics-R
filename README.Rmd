...
# 4. Visualization
norm_q_title <- latex2exp::TeX("Normalized de Gosson Coordinate Squeeze $\\Delta Q = 1/P$ \\[$q_0$\\]")
plot_title <- latex2exp::TeX("Landauer Action $A_L$ vs. de Gosson Squeeze $\\Delta Q$")
