...
```{r plot-staircase, fig.width=10, fig.height=10}
...
```{r plot-degeneracy-histogram, fig.width=10, fig.height=6}
...
```{r plot-fluctuation-histogram, fig.width=10, fig.height=6}
...
```{r plot-kolmogorov-complexity, fig.width=10, fig.height=6}
plot(
  x = df$microstate,
...
```{r plot-shannon-entropy, fig.width=10, fig.height=6}
plot(
  x = df$microstate,
...
```{r plot-h-vs-k, fig.width=8, fig.height=8}
...
```{r plot-total-entropy, fig.width=10, fig.height=6}
...
```{r plot-fluctuation-vs-K, fig.width=10, fig.height=6}
plot(
  x = df$kolmogorov_complexity,
  y = df$fluctuation,
...
```{r plot-fluctuation-vs-shannon, fig.width=10, fig.height=6}
plot(
...
```{r plot-lr-ratio-vs-microstate, fig.width=10, fig.height=6}
